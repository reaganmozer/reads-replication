...
par(mfrow=c(2,2),mar=c(4.1,8.9,2.5,1.1),mgp=c(2.5,0.5,0))
plot_textfx(dd.sci[dd.sci$grade==1 & dd.sci$type=="Planned",], main="Grade 1 Science",xlim=c(-0.8,0.8))
plot_textfx(dd.soc[dd.soc$grade==1 & dd.sci$type=="Planned",], main="Grade 1 Social Studies",xlim=c(-0.8,0.8))
plot_textfx(dd.sci[dd.sci$grade==2 & dd.sci$type=="Planned",], main="Grade 2 Science",xlim=c(-0.8,0.8))
plot_textfx(dd.soc[dd.soc$grade==2 & dd.sci$type=="Planned",], main="Grade 2 Social Studies",xlim=c(-0.8,0.8))
dev.off()
par(mfrow=c(1,1))
